    ...
    <TerminalShell userTier={mockUser.tier} currentSection="profile">
      <div className="px-5 py-6 space-y-5">
        ...
        <div className="space-y-2">
          ...
          <p className="text-tr-gray-light text-base">Your account, learning progress, and preferences.</p>
        </div>
        ...
        <div className="tr-card tr-accent-border">
          <div className="grid grid-cols-1 gap-3">
            <div>
              <div className="text-sm font-mono text-tr-gray-light mb-2">Username</div>
              <div className="text-lg font-bold">{mockUser.name}</div>
            </div>
            <div>
              <div className="text-sm font-mono text-tr-gray-light mb-2">Member Since</div>
        ...
        <div className="space-y-3">
          ...
          <div className="tr-card">
            <div className="flex items-center justify-between mb-4">
              ...
              <Link href="/membership" className="text-sm font-mono text-tr-red hover:text-tr-red/80 uppercase tracking-wider">
                Change Plan →
              </Link>
            </div>
        ...
        <div className="space-y-3">
          ...
          <div className="tr-card">
            ...
            <div className="grid grid-cols-1 gap-3 text-center">
              ...
              <div>
                ...
                <div className="text-sm text-tr-gray-light mt-1">Total</div>
              </div>
            </div>
          </div>
          ...
          <div className="tr-card">
            ...
            <Link href="/academy" className="text-sm font-mono text-tr-red hover:text-tr-red/80 uppercase tracking-wider">
              Continue Learning →
            </Link>
          </div>
        </div>
        ...
        <div className="tr-card tr-accent-border">
          ...
          <Link href="#" className="text-sm font-mono text-tr-red hover:text-tr-red/80 uppercase tracking-wider">
            Support Center →
          </Link>
        </div>
      </div>
